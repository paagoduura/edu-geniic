...
const ParentNotifications = () => {
  ...
  const loadAnnouncements = async () => {
    try {
      // RLS already filters announcements for parents based on their children's classes
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-muted/20 to-background">
      ...
      <main className="container mx-auto px-4 py-8 max-w-4xl">
        <Button variant="ghost" onClick={() => navigate('/parent')} className="mb-4">
            ...
            {isLoading ? (
              ...
              <Card>
                <CardContent className="py-12 text-center">
                  ...
                  <p className="text-muted-foreground">No announcements for your children yet.</p>
                </CardContent>
              </Card>
            ) : (
